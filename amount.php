...
<h1 style="text-align:center;">TYPE AMOUNT</h1>
<form action="php/amou.php">
<label style="padding-left:30px;">Name</label>
     	<input type="text" name="uname" placeholder="User Name"><br>

     	<label style="padding-left:30px;">Amount</label>
     	<input type="number" name="number" placeholder="Amount"><br>
